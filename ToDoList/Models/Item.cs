...
using System.ComponentModel.DataAnnotations; // Needed for validation and error messages
...
namespace ToDoList.Models
{
  public class Item
  {
    ...
    public ApplicationUser User { get; set; }  // used to associate user to thier items
  }
}